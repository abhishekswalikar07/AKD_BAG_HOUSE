...
<head>
    ...
    <title>Admin | Date Wise Repoets</title>
                    ...
                    <div class="content">
                        <div class="module">
                            ...
                            <div class="module-body table">
                                ...
                                <form method="post" style=" margin-left:20px;">
                                    <div class="row">
                                        <div class="span3">
                                            ...
                                            <input type="date" name="fromDate" class="form-control" required value="<?php if(isset($_POST['fromDate'])) echo $_POST['fromDate']; ?>">
                                        </div>
                                        <div class="span3">
                                            <label>To Date</label>
                                            <input type="date" name="toDate" class="form-control" required value="<?php if(isset($_POST['toDate'])) echo $_POST['toDate']; ?>">
                                        </div>
                                        <div class="span3">
                                            <button type="submit" name="filter" class="btn btn-primary">Display</button>
                                        </div>
                                    </div>
                                </form>
                                ...
                                ?>
                                <table cellpadding="0" cellspacing="1" border="0" class="datatable-1 table table-bordered table-striped display table-responsive">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Name</th>
                                ...
                                <?php 
                                        ...
                                        echo "<div class='alert alert-info'>No orders found between selected dates.</div>";
                                    }
                                } // end filter check
                                ?>
